...
/*
    ...
    - 기본값 병경 : ALTER TABLE 테이블명 MODIFY 컬럼명 자료형 DEFAULT 변경할 기본값;
...
/*
	1-4. 컬럼명 변경 (RENAMERENAME COLUMN)
    ALTER TABLE 테이블명 RENAME COLUMN 기존컬럼명 TO 변경할 컬럼명;
*/
-- dept_copy 테이블에서 dept_title 컬럼명을 location_name으로 변경
ALTER TABLE dept_copy RENAME COLUMN location_name TO dept_spec_name;
...
*/
ALTER TABLE dept_copy DROP CONSTRAINT dept_copy_UNIQUE;
