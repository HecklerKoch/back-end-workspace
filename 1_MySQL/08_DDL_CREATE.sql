...
CREATE TABLE mem_check(
    ...
    INSERT INTO mem_check VALUES (1,'user02','pass02','이동호','s',null, null, null);
    -- >> check 제약조건에 위배되었기 떄문에 오류 발생!
    
	INSERT INTO mem_check VALUES (1,'user02','pass02','이동호',null,null, null, null);
    -- >> check 제약조건으로 not null 조건또한 위배되었음을 확인!
    
    INSERT INTO mem_check VALUES (1,'user02','pass02','이동호','남',null, null, null);
...
/*
    ...
    ex) 회원번호, 학번, 사원번호, 부서코드, 직급코드, 제품번호, 주민번호, 운송장번호, ...
...
*/	DROP TABLE mem_pri;
    ...
    INSERT INTO mem_pri VALUES (1,'user02','pass01','배영운','남',null, null, null);
...
/*
    ...
    - 다른 테이블에 존재하는 값만 들어와야 되는 특정 컬럼에 부여하는 제약조건
		(단, NULL 값은 가질 수 있음)alter
	
    --> 다른 테이블을 참조한다고 표현
    --> 주로 FOREIGN KEY 제약조건에 의해 테이블 간의 관께가 형성됨!
*/
