...
public class A_String {
	...
	public void method2() {
		...
		//    substring(int beginIndex, ind endIndex) : String
		//    문자열의 beginIndex부터 endIndex -1 까지 (endIndex가 생량되면 끝까지)
		//    의 문자열을 새로 생성해서 리턴
		...
		System.out.println("8. toCharArry : " + arr);
		System.out.println(Arrays.toString(arr));
		
		// 베열을 리스트(ArrayList)로 변환
	...
	//    입력받은 구분자로 문자열을 분리해서 문자열의 배열로 담앗 리턴
