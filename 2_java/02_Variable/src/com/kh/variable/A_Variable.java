...
public class A_Variable {
	...
	public void printValue() {
		...
		System.out.println(r * 10 * pi); // syso 입력 후 ctrl + 스페이스바 + enter
	...
	public void variableTest() {
		 ...
		 * 변수의 선언
		 * 
		 * 자료형 변수명; - 자료형 : 어떤 값을 저장할지, 어떤 크기의 메모리를 할당받을지에 대한 정보 - 변수명 : 변수의 이름으로 값을 읽고,
		 * 쓰고, 지우는 작업을 할 때 사용
		 * 
		 * 변수의 초기화
		 * 
		 * 변수명 = 값; - 변수에 처음으로 값을 저장하는 것 - '='는 오른쪽 값을 왼쪽 변수에 대입(저장)하는 연산자
		 */
...
//		   bNum = 128; 에러 발생 -> 오버플로우(Overflow)
		...
		// 스택 메모리의 번수 공간에는 실제 변수값이 저장된 힙 메모리의 위치값을 저장
		String name = "장영태";
...
//		int maxNumber; // 자바에서
	...
	public void constant() {
		 ...
		 * final 자료형 변수명;
		 * 
		 * - 변하지 않는 값으로 특정 변수의 값이 변경되는 걸 원하지 않을 때 사용 - 초기화 이후에는 값을 변경할 수 없다. - 상수의 네이밍
		 * 규칙은 대문자로 표기, 여러 단어가 오면 _로 구분
		 */
