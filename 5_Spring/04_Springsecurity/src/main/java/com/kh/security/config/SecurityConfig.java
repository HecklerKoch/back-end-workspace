...
public class SecurityConfig {
	...
	@Bean
	public HttpSecurity filterChanin(HttpSecurity http) throws Exception {
		return http
				...
				.sessionManagement(session -> session.sessionCreationPolicy(SessionCreationPolicy.IF_REQUIERD)
