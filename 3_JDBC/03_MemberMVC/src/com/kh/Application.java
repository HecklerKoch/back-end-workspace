...
public class Application {
	...
	public void signUp() throws SQLException {
		...
		if(mc.signUp(new Member(id, password, name)) != null) {
	...
	public void changePassword(String id, String oldPw, String newPw) throws SQLException {
		...
		if(login(id,oldPw)!=null) {
			...
			PreparedStatement ps = conn.preparedStatement(p.getProperty("changePassword"));
		}
		return false;
